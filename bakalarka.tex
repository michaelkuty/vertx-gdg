...
\renewcommand*{\lstlistingname}{Ukázka kódů} %prejmenovani lstlisting
...
\bibitem{vertxNodejs}Verburg, Martijn \emph{An Interview with Tim Fox – Vert.x and why it’s better than NodeJS!} {[}online].{[}cit. 2014-03-22]. Dostupný z WWW:\url{http://www.jclarity.com/topics/interviews/tim-fox}

\bibitem{nettyInAction}Maurer, Norman \emph{Netty in Action}
{[}online]. {[}cit. 2014-03-20]. Dostupný z WWW: \url{http://www.manning.com/maurer/netty_meap_ch1.pdf}
...
\bibitem{javaChangelog}Oracle \emph{Package java.util.concurrent Description} {[}online].
...
\bibitem{vertigo}Halterman, Jordan \emph{Vertigo } {[}online].
{[}cit. 2014-07-31]. Dostupný z WWW \url{https://github.com/kuujo/vertigo}
...
\bibitem{plan}Fox, Tim \emph{Vert.x 3.0 Plan } {[}online].
{[}cit. 2014-08-02]. Dostupný z WWW \url{https://github.com/eclipse/vert.x/wiki/Vert.x-3.0-plan}
