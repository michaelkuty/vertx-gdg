...
\par\end{centering}
\caption{Výsledky prvního testu \emph{Tim Fox} \label{fig:test1}}
\end{figure}
...
\par\end{centering}
\caption{Výsledek druhého testu \emph{Tim Fox} \label{fig:test2}}
\end{figure}
