...
\section{Výkonnostní testy a porovnání s Node.js}

\subsection{Metoda testování}

\subsection{Výsledky}

\subsection{Srovnání s Node.js}
...
\hline 
\multicolumn{3}{|c|}{\textsf{}\textsf{\textbf{S}}\textsf{rovnání vlastností }}\tabularnewline
\hline
\hline 
