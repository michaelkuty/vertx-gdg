...
Hlavním cílem práce bude zjištění zda-li se  platforma Vert.x hodí pro vývoj distribuovaných jednostránkových aplikací dále jen SPA. Vytvoření jednoduchého webového editoru myšlenkových map. %Jednostránkové webové aplikace pro kolaborativní práci s mindmapami. % 
Na této jednoduché aplikaci bude demonstrován proces vývoje a nasazení webové aplikace pod platformou Vert.x. Vzhledem k rozsahu práce budou popsány spíše principy a architektura daného řešení než implementační detaily. Zdrojové kódy včetně návodu na spuštění aplikace jsou pak na serveru Github\footnote{www.github.com/michaelkuty} a na přiloženém médiu.
